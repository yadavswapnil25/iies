        ...
        <div class="gov-right">
            ...
            <div class="font-size-dropdown" title="Change Text Size">
              ...
              <div class="dropdown-menu" id="fontSizeMenu">
                <div data-size="1.3">A++</div>
                <div data-size="1.2">A+</div>
                <div data-size="1">A</div>
                <div data-size="0.9">A-</div>
            ...
            <div class="language-dropdown" title="Change Language">
              <button id="languageBtn">
                ...
                <span class="hindi-text">भाषा</span>
              </button>
    ...
    <header class="site-header">
      <div class="header-inner" role="banner">
        <div class="brand" aria-label="Ministry of Finance">
          ...
          <div class="titles">
            <h1>
              भारतीय अंतर्राष्ट्रीय आर्थिक सेवा<br /><span
        ...
        <ul id="mainMenu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="about.html">About IIES</a></li>
              <li><a href="our-minister.html">Our Minister</a></li>
              <li><a href="our-performance.html">Our Performance</a></li>
              <li>
                <a href="our-fin-min.html">Office of The Finance Minister</a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="noc-process.html">NOC Process</a></li>
              <li><a href="proc-guide.html">Procedure &amp; Guidelines</a></li>
              <li>
                <a href="object-certificate.html"
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a href="issuance-noc.html">Guideline for Issuance NOC</a>
              </li>
              <li>
                <a href="iies-officials.html">Guidelines for IIES Officials</a>
              </li>
              <li>
                <a href="super-agent.html">Guideline for Support Agent </a>
              </li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a href="super-agent-role.html" class="active"
                  >Role of Registered Facilitation Agent</a
                >
              </li>
              <li>
                <a href="super-agent-list.html">List of Registered Facilitation Agent</a>
              </li>
              <li>
                <a href="super-agent-hire.html">Engage a Registered Facilitation Agent </a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="law-act-policy.html">Act & Policy</a></li>
              <li>
                <a href="law-issue-noc.html"> Law Before Issuing NOC</a>
              </li>
            </ul>
          </li>
          <li><a href="penalty.html">Penalty</a></li>
          <li><a href="enquiry-form.html">Enquiry</a></li>
          <li><a href="contact-us.html">Contact IIES</a></li>
        </ul>
      </div>
    </nav>
      ...
      <div class="footer-inner">
        ...
        <div class="footer-col">
          ...
          <div class="footer-links">
            ...
            <a href="about.html">About IIES</a>
            <a href="our-minister.html">Our Minister</a>
            <a href="our-performance.html">Our Performance</a>
            <a href="noc-process.html">NOC Process</a>
          </div>
        </div>
        ...
        <div class="footer-col">
          ...
          <div class="footer-links">
            <a href="proc-guide.html">Procedure & Guidelines</a>
            <a href="issuance-noc.html">Guideline for Issuance NOC</a>
            <a href="penalty.html">Penalty</a>
            <a href="enquiry-form.html">Enquiry</a>
            <a href="contact-us.html">Contact IIES</a>
          </div>
        </div>
