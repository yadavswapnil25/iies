    ...
    <footer class="page-footer" role="contentinfo">
      <div class="footer-inner">
        ...
        <div class="footer-top">
          <!-- Column 1: Logo and Website Info -->
              ...
              <div class="footer-logo">
                <div class="brand" aria-label="Ministry of Finance">
                  <div class="titles">
                    ...
                    <p class="english-text" style="color: #fff;">Ministry of Finance, Government of India</p>
                  </div>
                </div>
              </div>
          ...
          <div class="footer-col">
            <strong class="footer-title">Quick Link</strong>
            <div class="footer-links">
              <a href="/">Home</a>
              <a href="/about/iies">About IIES</a>
