...
@section('title', 'Edit Press Release - Admin Panel')

@section('content')
<div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
    <h1 class="page-title">📰 Edit Press Release</h1>
    <a href="{{ route('admin.press-releases.index') }}" class="btn btn-secondary">← Back to Press Releases</a>
</div>

<div class="card">
    <form action="{{ route('admin.press-releases.update', $pressRelease) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input 
                    ...
                    id="url" 
                    name="url" 
                    value="{{ old('url', $pressRelease->url) }}"
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 15px;">
                <div>
                    ...
                    <input 
                        ...
                        id="sort_order" 
                        name="sort_order" 
                        value="{{ old('sort_order', $pressRelease->sort_order) }}"
                        min="0"
                ...
                <div>
                    ...
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <input 
                            ...
                            name="is_active" 
                            value="1" 
                            {{ old('is_active', $pressRelease->is_active) ? 'checked' : '' }}
                            style="margin: 0;"
                        >
