...
@section('title', 'Add Enforcement Directorate Item - Admin Panel')

@section('content')
<div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
    <h1 class="page-title">⚖️ Add Enforcement Directorate Item</h1>
    <a href="{{ route('admin.enforcements.index') }}" class="btn btn-secondary">← Back to Enforcement Directorate</a>
</div>

<div class="card">
    <form action="{{ route('admin.enforcements.store') }}" method="POST">
        @csrf
