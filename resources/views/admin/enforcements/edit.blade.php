...
@section('title', 'Edit Enforcement Directorate Item - Admin Panel')

@section('content')
<div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
    <h1 class="page-title">⚖️ Edit Enforcement Directorate Item</h1>
    <a href="{{ route('admin.enforcements.index') }}" class="btn btn-secondary">← Back to Enforcement Directorate</a>
</div>

<div class="card">
    <form action="{{ route('admin.enforcements.update', $enforcement) }}" method="POST">
        @csrf
        @method('PUT')
        
        <div style="margin-bottom: 20px;">
            <h3 style="color: #374151; margin-bottom: 15px;">Enforcement Directorate Information</h3>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input 
                    ...
                    id="title" 
                    name="title" 
                    value="{{ old('title', $enforcement->title) }}"
            ...
            <div style="margin-bottom: 15px;">
                <label for="hindi_text" style="display: block; margin-bottom: 5px; font-weight: 600; color: #374151;">Hindi Text</label>
                <input 
                    type="text" 
                    id="hindi_text" 
                    name="hindi_text" 
                    value="{{ old('hindi_text', $enforcement->hindi_text) }}"
                    placeholder="Enter Hindi text"
                    style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 6px; @error('hindi_text') border-color: #dc2626; @enderror"
                >
                <small style="color: #6b7280; font-size: 12px;">Optional - Hindi translation of the title</small>
                @error('hindi_text')
                    <div style="color: #dc2626; font-size: 14px; margin-top: 5px;">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input 
                    ...
                    id="url" 
                    name="url" 
                    value="{{ old('url', $enforcement->url) }}"
                    placeholder="https://enforcementdirectorate.gov.in/example"
                    required
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 15px;">
                <div>
                    ...
                    <input 
                        ...
                        id="sort_order" 
                        name="sort_order" 
                        value="{{ old('sort_order', $enforcement->sort_order) }}"
                        min="0"
                ...
                <div>
                    ...
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <input 
                            ...
                            name="is_active" 
                            value="1" 
                            {{ old('is_active', $enforcement->is_active) ? 'checked' : '' }}
                            style="margin: 0;"
                        >
        ...
        <div style="display: flex; gap: 10px; justify-content: flex-end; border-top: 1px solid #e5e7eb; padding-top: 20px;">
            ...
            <a href="{{ route('admin.enforcements.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
@endsection
