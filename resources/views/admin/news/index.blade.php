...
<div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <a href="{{ route('admin.news.create') }}" class="btn btn-primary">+ Add News Item</a>
</div>
...
<div class="card">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                <a href="{{ route('admin.news.edit', $item) }}" class="btn btn-secondary" style="padding: 6px 12px; font-size: 12px;">
                                    Edit
                                </a>
    ...
    @else
        <div style="text-align: center; padding: 40px;">
            ...
            <h3 style="color: #374151; margin-bottom: 8px;">No News Items</h3>
            <p style="color: #6b7280; margin-bottom: 20px;">Start by adding your first news item.</p>
